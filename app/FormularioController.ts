       ...
       instanceForm() {
        ...
        getFormElements(){
            ...
            if (this.formID==''||this.formID==null){
                ...
                axios.get('https://dev-trazalog.com.ar:8246/arbolado/api/ds/v1.0.0/formulario/'+this.formID,  {
    ...
    if ($("#picture_input").val() != "" || $("#treePic").attr("src") != "/resource/image/main-icon.png"){
        ...
        if (vue1.$data.taza === "Taza con árbol") {
            ...
            if (Connectivity.checkInternetSpeed() !== "offline") {
                ...
                let current_from_data = JSON.parse(store.get("form_data"));
                let array_form_data = [];
                ...
                let current_arbol_data = JSON.parse(store.get("arbol_data"));
                let array_arbol_data = [];
