              ...
              <tbody>
                ...
                if($reportes)
                {
                      ...
                      {    
                          ...
                          echo '<td><button class="btn btn-info btn-sm" onclick="Imagen('.$fila->arbo_id.')">Imagen</button></td>';
                          ...
                          echo '<td>'.$fila->COPA__M___MEDIDA_1.'</td>';//COPA__M__-_MEDIDA_1
                          echo '<td>'.$fila->COPA__M___MEDIDA_2.'</td>';//COPA__M__-_MEDIDA_2
